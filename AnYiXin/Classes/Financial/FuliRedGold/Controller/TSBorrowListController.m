...
@interface TSBorrowListController ()

@property (nonatomic, strong) TSInverListModel * inverListModel;
@property (nonatomic, strong) NSMutableArray * dataArr;
@end

@implementation TSBorrowListController
...
- (void)loadInfoData {
    ...
    parame[@"page"] = @1;
    parame[@"pagesize"] = @999;
    [[TSNetwork shareNetwork] postRequestResult:parame url:@"borrow_invest_list" successBlock:^(id responseBody) {
