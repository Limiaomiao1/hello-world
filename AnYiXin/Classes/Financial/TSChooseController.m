...
@interface TSChooseController () <DKFilterViewDelegate,UIAlertViewDelegate>
...
@implementation TSChooseController
...
- (void)setupSubViews {
    ...
    if (self.type == 1) {
         ...
         filterData = @[@"1个月",@"2个月",@"3个月",@"4个月",@"5个月",@"6个月",@"7个月",@"8个月",@"9个月",@"10个月",@"11个月",@"12个月"];
    }
    ...
    UIButton *filterButton = [[UIButton alloc] initWithFrame:CGRectMake(0, TSScreenH-114, TSScreenW, 50)];
    filterButton.backgroundColor = COLOR_MainColor;
    [filterButton setTitle:@"进行筛选" forState:UIControlStateNormal];
