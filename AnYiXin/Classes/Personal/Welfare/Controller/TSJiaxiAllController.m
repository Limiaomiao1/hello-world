...
#import "TSUnserController.h"
#import "TSExpiredController.h"
#import "TSUsedController.h"
#import "TSLockController.h"

@interface TSJiaxiAllController () <UIScrollViewDelegate>
...
@implementation TSJiaxiAllController
...
- (void)setAllChirldVC {
    ...
    TSUnserController * unuserVC = [[TSUnserController alloc]init];
    [self addChildViewController:unuserVC];
    TSLockController * lockVC = [[TSLockController alloc]init];
    [self addChildViewController:lockVC];
    TSUsedController * usedVC = [[TSUsedController alloc] init];
    [self addChildViewController:usedVC];
    TSExpiredController * expiredVC = [[TSExpiredController alloc] init];
