...
@interface TSCunGuanPSWWebVC ()<UIWebViewDelegate>

@end

@implementation TSCunGuanPSWWebVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.navigationItem.title = @"存管支付密码";
    UIWebView *web = [[UIWebView alloc]initWithFrame:CGRectMake(0, 0, TSScreenW, TSScreenH)];
    [self.view addSubview:web];
    web.delegate = self;
    NSString * urlStr = [TSAPI_Image_PREFIX stringByAppendingString:@"cgpwd"];
