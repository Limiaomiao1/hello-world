...
@interface TSWithdrawWebController ()<UIWebViewDelegate>

@end

@implementation TSWithdrawWebController
...
- (void)viewDidLoad {
    ...
    web.delegate = self;
    NSString * urlStr = [TSAPI_Image_PREFIX stringByAppendingString:@"cash"];
