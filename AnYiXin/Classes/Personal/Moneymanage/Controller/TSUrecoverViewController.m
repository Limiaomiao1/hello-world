...
@interface TSUrecoverViewController ()<UITableViewDelegate, UITableViewDataSource>
/** TableView */
...
@implementation TSUrecoverViewController
...
- (void)loadDataArray {
    ...
    TSWeakSelf;
    [[TSNetwork shareNetwork] postRequestResult:dic url:@"tendbacking" successBlock:^(id responseBody) {
