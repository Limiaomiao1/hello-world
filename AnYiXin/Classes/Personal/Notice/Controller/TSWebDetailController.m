...
@interface TSWebDetailController ()<WKNavigationDelegate,WKUIDelegate>
/** 网页视图 */
...
@implementation TSWebDetailController
...
- (void)loadWebInfo {
    TSWeakSelf;
    [[TSNetwork shareNetwork] postRequestResult:@{@"id":self.ID} url:@"gonggaobyid" successBlock:^(id responseBody) {
        
        [weakSelf.webView loadHTMLString:responseBody[@"data"][@"art_content"] baseURL:nil];
