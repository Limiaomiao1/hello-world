...
- (instancetype)init{
    if (self = [super init]) {
        ...
        self.buttonSelectBorderColor = COLOR_MainColor; //选中边框颜色
        self.buttonSelectBackGroundColor = COLOR_MainColor; //选中按钮的背景色
...
//    TSLog(@"%ld  %@",(long)[SelectBtn sharedManager].modelBtn.tag,[SelectBtn sharedManager].modelBtn.title);
