...
- (void)hideInWindow
{
    if ([self isShowInWindow]) {
        ...
        TSLog(@"self.superview is nil, or isn't TYShowAlertView");
    }
}
...
- (void)hideInController
{
    if ([self isShowInAlertController]) {
        ...
        TSLog(@"self.viewController is nil, or isn't TYAlertController");
    }
}
...
- (void)hideView
{
    if ([self isShowInAlertController]) {
        ...
        TSLog(@"self.viewController is nil, or isn't TYAlertController,or self.superview is nil, or isn't TYShowAlertView");
    }
}
